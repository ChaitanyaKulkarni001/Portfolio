...
function Skills() {
  ...
  return (
    <div id="skills" className="relative z-50 border-t   bg-gray-800 text-white z-100 border-[#25213b]">
        <img src={img} alt="" className='fixed' />
      {/* Background Effects */}
        ...
        >
          {skillsData.map((skill, id) => (
              <div className="w-36 min-w-fit h-fit flex flex-col items-center justify-center transition-all duration-500 m-3 sm:m-5 rounded-lg group relative hover:scale-[1.15] cursor-pointer" key={id}>
                {/* {console.log(src={skillsImage(skill)})} */}
